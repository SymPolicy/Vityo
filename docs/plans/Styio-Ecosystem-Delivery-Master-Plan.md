...
| `M1` | `nightly` 的 language/execution contract 正式消费，停止使用未发布语义 | `docs/external/for-styio/` `docs/contracts/` | adapter contract tests |
| `M2` | `pafio` 的 project graph/toolchain/source/registry payload 正式消费 | `docs/external/for-pafio/` `docs/contracts/` | `flutter analyze && flutter test` |
