...
11. Pafio / Styio-Cloud 重命名会触达 app command registry、shell scaffold 和 shell model；同批检查命令 id、可见 label、adapter import path 和 legacy integration export，确保主壳不再以旧包管理器命名暴露 backend workflow。
